...
- When asserting paths printed by `make -C`, derive the expected fixture path with `pwd -P`; macOS can preserve logical `/var` in the test variable while Make reports physical `/private/var`.
